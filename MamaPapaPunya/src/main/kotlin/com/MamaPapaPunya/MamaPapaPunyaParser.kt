...
// --- MAMAPAPA DEWASA MODELS (RENAMED) ---
data class MamaPapaDewasaSearchResponse(
    @JsonProperty("data") val data: ArrayList<MamaPapaDewasaItem>? = arrayListOf(),
    @JsonProperty("success") val success: Boolean? = null
)

data class MamaPapaDewasaItem(
    @JsonProperty("name") val name: String? = null,
    @JsonProperty("title") val title: String? = null,
...
// --- MAMAPAPA MOVIEBOX MODELS (RENAMED) ---
data class MamaPapaMovieboxSearch(val data: MamaPapaMovieboxData?)
data class MamaPapaMovieboxData(val items: List<MamaPapaMovieboxItem>?)
data class MamaPapaMovieboxItem(val subjectId: String?, val title: String?, val releaseDate: String?, val detailPath: String?)
data class MamaPapaMovieboxStreams(val data: MamaPapaMovieboxStreamData?)
data class MamaPapaMovieboxStreamData(val streams: List<MamaPapaMovieboxStreamItem>?)
data class MamaPapaMovieboxStreamItem(val id: String?, val format: String?, val url: String?, val resolutions: String?)
data class MamaPapaMovieboxCaptions(val data: MamaPapaMovieboxCaptionData?)
data class MamaPapaMovieboxCaptionData(val captions: List<MamaPapaMovieboxCaptionItem>?)
data class MamaPapaMovieboxCaptionItem(val lanName: String?, val url: String?)
